...
var marker, i, linkName, linkAddress, streetView;
...
var infoContent = '<div class="wikipedia-container">'+'<h3 class="placeTitle"></h3>'+'<h4 class="wikipedia-header">Wikipedia Links</h4>'+'<ul class="wikipedia-links"></ul>'+'<div class="streetViewWindow"></div>'+'</div>';
...
function loadStreetView(){
    ...
    streetView = "https://maps.googleapis.com/maps/api/streetview?size=230x120&location=" + place;
